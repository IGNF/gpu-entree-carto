...
Détail des CSS par page : [LibCssBundles.md](./LibCssBundles.fr.md) (chunks, SVGO webpack, accueil minimal).
...
**Fallback autocomplete seul** ([LocationSearchWidget](./LocationSearchWidget.fr.md)) — CSS ≈ 1 Ko :
...
Voir [mountSearchEngine.md](./mountSearchEngine.fr.md).  
Fallback léger : `gpu.mountLocationSearch` ([LocationSearchWidget.md](./LocationSearchWidget.fr.md)).
...
Les `*.min.css` entree-carto sont déjà minifiés par Vite. Exclure `vendor/entree-carto/css/` du `CssMinimizerPlugin` évite des avertissements **postcss-svgo** (`Parsed entity count exceeds max entity count` sur d’anciennes polices Remix SVG). Voir [LibCssBundles.md](./LibCssBundles.fr.md).
