...
| --------------------------------- | -------------------------------- | -------------- | --------------------------------------- | ---------------------------------------------------------------------- |
| `TileLayerSwitcherControl`        | 6 fonds (Plan, Ortho, Cadastre…) | Non            | `LayerSwitcher` **Partiel**             | [TileLayerSwitcher](./TileLayerSwitcher.fr.md) **Partiel** (3 fonds démo) |
| `TreeLayerSwitcherControl`        | Arbre couches métier GPU         | Non            | `LayerSwitcher` + `Catalog` **Partiel** | [TreeLayerSwitcher](./TreeLayerSwitcher.fr.md) **Partiel** (stubs)        |
...
| `TabsPanelsControl`                 | Onglets fiche / couches | Non            | — **Non**                    | [TabPanelsControl](./TabPanelsControl.fr.md) **Partiel** (4 onglets) |
