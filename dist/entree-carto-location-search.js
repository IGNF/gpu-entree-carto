...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-sfc`;
  ...
  **/
  ...
  function normalizeGeopfResult(item) {
    return {
  ...
  class Geocode {
    ...
    autoComplete(address, success, fail, options = {}) {
      var _a;
      ...
      const Gp = window.Gp;
      if ((_a = Gp == null ? void 0 : Gp.Services) == null ? void 0 : _a.autoComplete) {
    ...
    async fetchCompletion(text, maximumResponses, type) {
      const url = new URL(
  ...
  class LocateControl {
    isAllowedResult(autocompleteResult) {
      if (autocompleteResult.type === "StreetAddress" && autocompleteResult.kind === "municipality") {
        return false;
      }
      return true;
    }
    getTextFromAutocompleteResult(autocompleteResult) {
      var _a;
  ...
  const _sfc_main = /* @__PURE__ */ defineComponent({
    __name: "LocationSearchWidget",
    props: {
      label: { default: "Rechercher par lieu:" },
      placeholder: { default: "Rechercher une adresse, une ville, un lieu..." },
      mode: { default: "redirect" },
      mapUrl: { default: "/map/" },
      method: { default: "POST" },
      maximumResponses: { default: 10 },
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      const props = __props;
      const emit2 = __emit;
      const query = /* @__PURE__ */ ref(props.initialQuery);
      const suggestions = /* @__PURE__ */ ref([]);
      const open = /* @__PURE__ */ ref(false);
      const loading = /* @__PURE__ */ ref(false);
      const activeIndex = /* @__PURE__ */ ref(-1);
      ...
      function runSearch(value) {
        ...
        geocode.autoComplete(
          ...
          (response) => {
            ...
            loading.value = false;
            suggestions.value = (response.suggestedLocations ?? []).filter((loc) => locate.isAllowedResult(loc)).map((loc) => ({
              ...loc,
        ...
        return openBlock(), createElementBlock("form", {
          ...
          createBaseVNode("div", _hoisted_1, [
            ...
            createBaseVNode("input", {
              ...
              "aria-activedescendant": activeIndex.value >= 0 ? `${listId.value}-opt-${activeIndex.value}` : void 0,
            ...
            createBaseVNode("button", {
              ...
              createBaseVNode("span", { class: "fr-sr-only" }, "Rechercher", -1)
            ])], 8, _hoisted_3)
          ]),
          withDirectives(createBaseVNode("ul", {
            ...
            role: "listbox",
            "aria-label": __props.label || "Suggestions"
          }, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(suggestions.value, (item, index) => {
              return openBlock(), createElementBlock("li", {
                id: `${listId.value}-opt-${index}`,
                key: `${item.fullText}-${item.position.x}-${item.position.y}-${index}`,
                role: "option",
                "aria-selected": index === activeIndex.value,
                class: normalizeClass(["ec-location-search__suggestion", { "ec-location-search__suggestion--active": index === activeIndex.value }]),
                onMousedown: withModifiers(($event) => selectLocation(item), ["prevent"])
              }, toDisplayString(item.fullText), 43, _hoisted_5);
            }), 128))
          ], 8, _hoisted_4), [
            [vShow, open.value && suggestions.value.length]
          ])
        ], 32);
      };
    }
  ...
  exports.default = api;
  exports.mountLocationSearch = mountLocationSearch;
  Object.defineProperties(exports, { __esModule: { value: true }, [Symbol.toStringTag]: { value: "Module" } });
})(this.EntreeCartoLocationSearch = this.EntreeCartoLocationSearch || {});
